...
import temporalbehavior.FreetimeState;
import temporalbehavior.State;
...
public class DTNHost implements Comparable<DTNHost> {
  ...
  private boolean onTheWayToLecture = false;
  ...
  private final Map<DTNHost,Double> connectedHosts = new HashMap<>();
  ...
  public void setOnTheWayToLecture(boolean onTheWayToLecture){
    this.onTheWayToLecture = onTheWayToLecture;
  }
